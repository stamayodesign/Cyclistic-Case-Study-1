...
```{r Year 2022 Bike Popularity Casual Three,figures-side , fig.show="hold", out.width="30%",fig.align='center', echo=FALSE}
...
```{r Year 2022 Bike Popularity Member Three, figures-side, fig.show="hold", out.width="30%",fig.align='center', echo=FALSE}
