...
#### Trip Frequency
<a name="Ref2" />The first thing I wanted to check was how many trips per month casual and member customers accrued. The code can be found in the [Appendix here](#Appx3).
...
```{r View graph_year2022_tripfreq_customer,fig.width=100,fig.height=11}}
...
#### <a name="Appx3"/>Applying Functions to Clean Data
